...
public class Scenario_12 extends BaseClass{
@Test
	public void payment() throws InterruptedException {
        ...
        for (WebElement method : paymentMethods) {
            ...
            js.executeScript("arguments[0].scrollIntoView(true);", method);
            Thread.sleep(1000);
            js.executeScript("arguments[0].click();", method);

            Thread.sleep(1500);

            System.out.println(
                "Selected: " + method.getAttribute("value")
                + " → " + method.isSelected()
            );
