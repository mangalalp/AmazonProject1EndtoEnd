...
Thread.sleep(3000);
        ...
        driver.findElement(By.linkText("CPAP Machines")).click();
        Thread.sleep(3000);
        driver.findElement(By.xpath("(//div[@class='elementor-widget-container']/div/div)[8]")).click();
        driver.findElement(By.xpath("(//span[text()='Add to wishlist'])[1]")).click();
        Thread.sleep(3000);
        ...
        Thread.sleep(3000);
        WebElement wishlistProduct = driver.findElement(By.cssSelector(".wishlist_table"));
